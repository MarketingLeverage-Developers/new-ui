...
import { usePinnedColumnControl2 } from '../../../shared/headless/AirTable/hooks/usePinnedColumnControl2';
...
export const PinnedColumnControlsPanel2 = <T,>() => {
    const api = usePinnedColumnControl2<T>();
    ...
    return (
        <div className={tableStyles.PanelRoot}>
            ...
            <div className={tableStyles.PanelBody}>
                <ManySelect value={api.pinnedColumnKeys} onChange={(next) => api.setPinnedColumnKeys(next)}>
