...
import styles from './GranterSubSidebar.module.scss';

type GranterSubSidebarProps = {
    children: React.ReactNode;
};

const STORAGE_KEY = 'ml:granter:subSidebarWidthPx';
...
const GranterSubSidebar = ({ children }: GranterSubSidebarProps) => {
    ...
    return (
        <aside
            ref={sidebarRef}
            className={styles.SubSidebarArea}
            style={style}
            data-resizing={isResizing ? 'true' : 'false'}
            data-collapsed={hasVisibleContent ? 'false' : 'true'}
        >
            <div ref={contentRef} className={styles.SubSidebarContent}>
                {children}
            </div>
            {hasVisibleContent ? (
                <div
...
export default GranterSubSidebar;
