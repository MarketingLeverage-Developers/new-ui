...
import styles from './SectionFieldDateTextInput.module.scss';
...
export type SectionFieldDateTextInputProps = {
    value?: string | null;
    onChange?: React.ChangeEventHandler<HTMLInputElement>;
    onValueChange?: (value: string) => void;
    pickerDisabled?: React.ComponentProps<typeof SingleDatePicker>['disabled'];
    placeholder?: string;
    disabled?: boolean;
    name?: string;
    id?: string;
...
const DatePickerDropdownContent = ({
    selectedDate,
    pickerDisabled,
    onSelectDate,
}: DatePickerDropdownContentProps) => {
...
const SectionFieldDateTextInput = React.forwardRef<HTMLInputElement, SectionFieldDateTextInputProps>(
    (
        {
            value,
            onChange,
...
SectionFieldDateTextInput.displayName = 'SectionFieldDateTextInput';

export default SectionFieldDateTextInput;
