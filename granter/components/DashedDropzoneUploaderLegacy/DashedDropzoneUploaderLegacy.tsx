...
import styles from './DashedDropzoneUploaderLegacy.module.scss';

export type DashedDropzoneUploaderLegacyVariant = 'image' | 'file';
...
export type DashedDropzoneUploaderLegacyProps<TItem extends object> = {
    variant: DashedDropzoneUploaderLegacyVariant;
    value?: TItem[];
...
const DashedDropzoneUploaderLegacy = <TItem extends object>({
    variant,
    value = [],
    onChange,
    uploader,
    ...
    showEmpty = true,
    className,
}: DashedDropzoneUploaderLegacyProps<TItem>) => {
...
export default DashedDropzoneUploaderLegacy;
